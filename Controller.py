...
wdir    = r"E:\LOCALORTHO"
files   = ["T1","T0","T2"]
path,o,psC,psF,w,md  = METAA.Initialize(log,wdir,files)

print("[IMAGE 0]")
gt0,Img0C,ImgB0C,MaskB0C,fx0C,fy0C,Img0F,fx0F,fy0F                    = METAA.OrthOpenin(psC,psF,path[0])
...
for i in range(1,len(path)):
    print("[IMAGE "+str(i)+"]")
    gt1,Img1C,ImgB1C,MaskB1C,fx1C,fy1C,Img1F,fx1F,fy1F                = METAA.OrthOpenin(psC,psF,path[i])
    ...
    X1Oa,Y1Oa,Lon0Oa,Lat0Oa,X1Fa,Y1Fa,X0Fa,Y0Fa,CVa,dx,dy,RECC_over   = RECCM.PatchMatch(psF,w,md,EdgesC1F,gt1,fx1F,fy1F,EdgesC0F,gt0,fx0F,fy0F,Contour0F,x_offset,y_offset)
    ...
    METAA.CreateFigs(log,i,wdir,files,psC,psF,w,Img0C,Img1C,Img0F,Img1F,EdgesA0C,EdgesB0C,EdgesC0C,EdgesA1C,EdgesB1C,EdgesC1C,EdgesA0F,EdgesB0F,EdgesC0F,EdgesA1F,EdgesB1F,EdgesC1F,X0C,Y0C,X1C,Y1C,X0Fa,Y0Fa,X1Fa,Y1Fa,X0Fb,Y0Fb,X1Fb,Y1Fb,CVb)
    RECCM.Georegister(wdir,path[i],files[i],gcplist)

...
ppp            = 20        # Use <...> points per photo to georeference.
...
for i in range(1,len(path)):
    ...
    dist, dist_lon, dist_lat, origin_x, origin_y, target_lon, target_lat = RECC.patch_match(i, edges, gt, fact_x, fact_y, x_b, y_b, mask, edges_0, gt_0, fact_x_0, fact_y_0, x_b_0, y_b_0, mask_0, ppp, cv_max, dst_max, w, v, steps, it_max)

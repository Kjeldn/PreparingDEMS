...
if __name__ == "__main__":
    file = gdal.Open(r"D:\VanBovenDrive\VanBoven MT\500 Projects\Student Assignments\Interns\Plants compare3\c07_hollandbean-Joke Visser-201906191208_DEM-GR.tif")
    projection = file.GetProjection()
    band = file.GetRasterBand(1)
    array = get_ridges_array(band.ReadAsArray())
    file = None

...
if __name__ == '__main__':
    ...
    for i in range(1,len(path)):
        ...
        plist,func,grid                                                                     = RECCM.InitiMatch(plist,Edges0F,Edges1F,MaskB0F,CV1,gt0F,gt1F,x_off,y_off)                                                             
        plist,x0,y0,x1,y1,CVa,dx,dy                                                         = RECCM.MultiMatch(plist,func,grid,Edges0F,Edges1F)

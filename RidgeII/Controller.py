...
orthomosaic and DEM pair for georegistration, which is refered to as the base. Both sets are then processed 
to binary maps using METAA and CANNY functions. RECCM functions take the binary maps and find corresponding 
locations, which are used to georegister the pair found in the inbox.
---
...
Img0C    | 2D arr | Rescaled and equalised orthomosaic
...
if __name__ == '__main__':
    ...
    for path in pathlist:
        ...
        plist,x0,y0,x1,y1,CV,dx,dy               = RECCM.MulMatch(plist,Edges0F,Edges1F,Edges1Fa,CV1,x_off,y_off,grid,md,c1,c2,gt0F,gt1F)

...
if __name__ == '__main__':
    ...
    for path in pathlist:
        ...
        plist,Edges1Fa,x_off,y_off,grid,md,c1,c2,sf = RECCM.IniMatch(plist,Edges0F,Edges1F,MaskB0F,MaskB1F,x_off,y_off,CV1,gt0F,gt1F)    
        ...
        f3                                          = METAA.MoveFile(path,rtu,nrtu,dstr,rec,GCPstat,sf)    
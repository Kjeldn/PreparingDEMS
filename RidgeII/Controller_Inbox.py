...
if __name__ == '__main__':
    ...
    for path in metapath:
        ...
        for i in range(1,len(path)):
            ...
            plist,pbar,inp,pool                                                                 = RECCM.InitiMatch(plist,Edges0F,Edges1F,MaskB0F,CV1,gt0F,gt1F,fx0F,fy0F,fx1F,fy1F,x_off,y_off)       
            plist,origin_x,origin_y,target_lon,target_lat,x0,y0,xog,yog,xof,yof,x1,y1,CVa,dx,dy = RECCM.MultiMatch(plist,pbar,pool,inp,Edges0F,Edges1F)
